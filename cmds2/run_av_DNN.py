...
from models.av_dnn import av_DNN
...
from utils.userdefine_network_config import NetworkConfig
...
if __name__ == '__main__':
    ...
    if cfg.do_dropout:
        ...
        dnn = av_DNN(numpy_rng=numpy_rng, theano_rng = theano_rng, cfg = cfg)
